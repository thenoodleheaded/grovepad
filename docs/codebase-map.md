...
| Whole-card responsive tiers, content-safe sizing, dead zones, auto-height | [sizingProfiles.ts](../src/widgets/sizingProfiles.ts), [WidgetCard.tsx](../src/components/widgets/WidgetCard.tsx) | Static windows + compact/standard/expanded thresholds: widget registry; mounted authority: [liveWidgetSizing.ts](../src/store/liveWidgetSizing.ts); clamp: [widgetLayoutSlice.ts](../src/store/slices/widgetLayoutSlice.ts) | Article XII.1 in [widget constitution](widget-constitution.md), Article XVIII.2 in [glass constitution](widget-glass-constitution.md) | sizing profile + live sizing tests, `npm run check:full`, narrow/wide widget smoke |
