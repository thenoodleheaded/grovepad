...
| Persistence, reload, IndexedDB, cloud sync | [persistence.ts](../src/utils/persistence.ts) | Schema/parser: [persistedBoardSchema.ts](../src/utils/persistedBoardSchema.ts) and [persistence.ts](../src/types/persistence.ts); adapters: [boardDatabase.ts](../src/utils/boardDatabase.ts), [cloudSync.ts](../src/utils/cloudSync.ts) | Persistence flow in [architecture map](architecture-map.md) | `npm run check` plus reload smoke |
