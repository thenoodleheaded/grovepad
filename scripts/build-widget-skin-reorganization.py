...
# Reviewed schema additions that have since shipped as genuine alternate views.
SKIN_ENTRIES = {
    ("dialog", "Roleplay"),
}


# These 82 choices existed before the 611-item opportunity catalogue. This
...
def render() -> str:
    ...
    lines = [
        ...
        "",
        "> Complete ownership ledger for the 82 original choices and all 611 catalogue proposals. "
        ...
        "## Result",
        "",
        f"- **693 choices reviewed**: 82 original choices plus 611 expansion proposals.",
    ...
    lines += [
        "## Complete 611-entry ownership ledger",
        "",
    ...
    lines += [
        ...
        "- The 50 searchable Atlas widgets — the former Tracker presets, plus the tracking, study, "
        "and specialist cards built on the same envelope — were the last public widgets with no skins "
        "of their own. They now wear Object, Dial, Ledger, Trend, Schedule, and Compact: six ways of "
        "seeing one stored record. Each type is offered only the shapes its declared spec can fill, so "
        "a card never presents an empty chart as a choice, and every type keeps at least Object and "
        "Compact. See the Atlas skins route in the [codebase map](codebase-map.md).",
        "",
        "## Follow-through rule",
        "",
