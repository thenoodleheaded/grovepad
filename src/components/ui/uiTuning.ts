  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        default: 16,
        unit: '%',
        help: 'How much a raised island (a content group inside a card) catches the light. One setting for every island — content groups, subpanels, and text fields alike.',
      },
    ],
  },
  {
