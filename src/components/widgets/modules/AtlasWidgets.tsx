...
export function AtlasWidget({type,data,onChange,showModePicker=false}:{type:AtlasType;data:AtlasWidgetData;onChange:(data:ModuleData)=>void;showModePicker?:boolean}){
  const spec=ATLAS_CATALOG[type]
